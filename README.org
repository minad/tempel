...
There are many alternative packages which provide abbreviation or snippet expansion.

- abbrev.el (builtin)
- skeleton.el (builtin)
- tempo.el (builtin)
- [[https://github.com/cdominik/cdlatex][cdlatex.el]]
- [[https://github.com/ymarco/auto-activating-snippets][aas.el]]
- [[https://github.com/jiahaowork/muban.el][muban.el]]
- [[https://github.com/pkazmier/snippet.el][snippet.el]]
- [[https://nschum.de/src/emacs/tempo-snippets/][tempo-snippets.el]]
- [[https://github.com/joaotavora/yasnippet][yasnippet.el]]
